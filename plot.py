...
plt.savefig("plots/slate/dg-tsslac-"+platform + "-" + vec + ".pdf", format="pdf")
...
plt.savefig("plots/slate/dg-tsslac-"+"roofline-" + platform + ".pdf", format="pdf", bbox_extra_artists=(lgd,), bbox_inches='tight')
